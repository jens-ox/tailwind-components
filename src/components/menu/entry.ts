...
import EntryInterface from '../../interfaces/menu/entry'

const baseClass =
  'absolute -ml-4 mt-3 transform transition-all px-2 w-screen max-w-md sm:px-0 lg:ml-0 lg:left-1/2 lg:-translate-x-1/2'
